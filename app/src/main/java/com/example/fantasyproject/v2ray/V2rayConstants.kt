package com.example.fantasyproject.v2ray
...
object V2rayConstants {
    ...
    const val BROADCAST_ACTION_SERVICE = "com.example.fantasyproject" + ".action.service"
    const val BROADCAST_ACTION_ACTIVITY = "com.example.fantasyproject" + ".action.activity"
